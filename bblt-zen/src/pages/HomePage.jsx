      ...
      <section className="features-section">
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p className="feature-description">Crea la tua bevanda perfetta scegliendo tra centinaia di combinazioni</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
            ...
            <p className="feature-description">Ordina dal tuo tavolo e ricevi la tua bevanda in pochi minuti</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
            ...
            <p className="feature-description">Utilizziamo solo ingredienti di alta qualità e freschi ogni giorno</p>
          </div>
        </div>
      </section>
    </div>
